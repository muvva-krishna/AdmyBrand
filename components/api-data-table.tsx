...
import { Search, ChevronUp, ChevronDown, Download, RefreshCw } from 'lucide-react';
import { motion } from 'framer-motion';
import { ApiCampaignData } from '@/lib/api-service';
...
type SortField = keyof ApiCampaignData;
type SortDirection = 'asc' | 'desc';

export function ApiDataTable({ data, isLoading = false, onRefresh }: ApiDataTableProps) {
  ...
  const exportData = () => {
    ...
    a.href = url;
    a.download = 'real-time-campaign-data.csv';
    a.click();
  ...
  if (isLoading) {
    return (
      ...
      >
        <Card>
          <CardHeader>
            <CardTitle>Real-Time Campaign Performance</CardTitle>
            <CardDescription>Loading live campaign data...</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <CardHeader className="pb-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>Live analytics from multiple data sources</CardDescription>
            </div>
                ...
                {paginatedData.map((item, index) => (
                  ...
                  >
                    ...
                    <TableCell className={cn(
                      "font-medium",
                      item.ctr > 0 ? "text-green-600" : "text-red-600"
                    )}>
                      {item.ctr > 0 ? '+' : ''}{item.ctr}%
                    </TableCell>
                    <TableCell>
